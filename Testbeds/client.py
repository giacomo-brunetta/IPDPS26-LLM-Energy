...
parser = argparse.ArgumentParser(description="Send parallel inference requests to an OpenAI-compatible endpoint.")
parser.add_argument(
    "--batch-size",
    type=int,
    default=8,
    help="Number of parallel worker processes used to split and send requests (default: 8).",
)
